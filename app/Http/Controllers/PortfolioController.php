    ...
    public function index()
    {
        $projects = [
            [
                ...
                'description' => 'I was tasked with creating the SPA-based javascript architecture for the Jurassic World Movie Trailer site. Part of a small team of 4 devs, we created a Backbone/Marionette based structure that drove a data model off json files and served rich video and javascipt animations to create a dynamic simulation of what a real-world park website would look like. JurassicWorld.com has been visited by over 6 million people, including over 300,000 in a single day; with over 30 million pageviews to date.',
            ...
            [
                ...
                'description' => 'The Age Of Adaline Tumblr theme was an interesting project for Trigger Digital. The idea was to create a scrolling-through-time effect, using historical images already posted to Tumblr, in the promotion of the film "Age Of Adaline" by New Line Cinema starring Blake Lively. One of the unique technical challenges was vertically synching the images based on chronology, while providing a different scroll rate on the right side and the left side. They wanted an eerie out-of-sync effect to give the sense of time being elastic and relative. I created this radical Tumblr theme using Javascript, BackboneJS, and css all while retaining basic Tumblr functionality. Users could click into posts, like them, comment, and even share them out to social media.',
