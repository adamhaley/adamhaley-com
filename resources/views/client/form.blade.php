<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('description', $client->description, ['class' => 'form-control' . ($errors->has('description') ? ' is-invalid' : ''), 'placeholder' => 'Description']) }}
        ...
        <div class="form-group">
            {{ Form::label('url') }}
            {{ Form::text('url', $client->url, ['class' => 'form-control' . ($errors->has('url') ? ' is-invalid' : ''), 'placeholder' => 'Url']) }}
